...
public class DisplayIncomeMultiplier : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        if (gameManager != null && gameManager.incomeMultiplier > 1f)
        {
    ...
    {
        if (gameManager != null)
            gameManager.IncomeMultiplierPurchased += OnIncomeMultiplierPurchased;
    ...
    void OnIncomeMultiplierPurchased() => Reveal();
    ...
    void Update()
    {
        ...
        _text.text = "Income Multiplier: " + CurrencyAmountFormatter.FormatStatFloat(gameManager.incomeMultiplier);
    }
}
